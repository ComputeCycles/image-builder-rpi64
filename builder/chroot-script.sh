...
apt-get update
apt-get -o Dpkg::Options::="--force-overwrite" install -y --allow-unauthenticated swift5dev=6.0
wget -q https://www.dropbox.com/s/m0vqevc7n9mcm1e/libicudata.so.55?dl=1 -O usr/lib/aarch64-linux-gnu/libicudata.so.55
wget -q https://www.dropbox.com/s/1jm6n5bm7hti36q/libicui18n.so.55?dl=1 -O usr/lib/aarch64-linux-gnu/libicui18n.so.55
wget -q https://www.dropbox.com/s/xptmaki14oczmos/libicuuc.so.55?dl=1 -O usr/lib/aarch64-linux-gnu/libicuuc.so.55

# make llvm-6.0 the default instead 3.8, this picks up a modern lldb
